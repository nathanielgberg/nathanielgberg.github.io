    ...
    extend: {
      ...
      keyframes: {
        ...
        "slide-up": {
          ...
          "30%": { transform: "translateY(100px)", opacity: "0.3" },
          "60%": { transform: "translateY(50px)", opacity: "0.6" },
      ...
      animation: {
        ...
        "fade-in-sequential": "fade-in-sequential 1.2s ease-out forwards",
        "slide-up": "slide-up 1.8s cubic-bezier(0.16, 1, 0.3, 1)",
